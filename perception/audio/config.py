...
class WakeWordConfig:
    ...
    model_paths: List[str] = field(
        default_factory=lambda: [
            "C:/Users/amarq/OneDrive/Documentos/Contenido/Proyectos/Programación/NORA/perception/audio/models_download/hey_nora.onnx"
        ]
    )
    threshold: float = 0.5
...
class AudioPublisherConfig:
    ...
    backend_event_url: str = "http://127.0.0.1:8000/api/events/ingest/audio/"
