...
// Mock data for user commands
const userCommands = [
  {
    id: 1,
    user: "User",
    command: "Activate voice recognition",
    timestamp: "2023-07-15 14:32:21",
  },
  {
    id: 2,
    user: "Admin",
    command: "System diagnostic",
    timestamp: "2023-07-15 13:45:09",
  },
  {
    id: 3,
    user: "User",
    command: "Set reminder for meeting",
    timestamp: "2023-07-15 12:30:15",
  },
  {
    id: 4,
    user: "Guest",
    command: "Weather forecast",
    timestamp: "2023-07-15 11:22:47",
  },
  {
    id: 5,
    user: "Admin",
    command: "Update system parameters",
  ...
  },
  {
    ...
    timestamp: "2023-07-15 09:05:12",
  },
  {
    id: 7,
    user: "Admin",
    command: "Run security scan",
    timestamp: "2023-07-14 22:45:38",
  },
];

const AdminDashboard = () => {
  // State for module toggles
  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white font-['Roboto',sans-serif] snap-y snap-mandatory overflow-y-scroll scroll-smooth">
      <Navbar />
      <motion.div
        className="pt-24 px-4 md:px-6 lg:px-8 snap-start"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card className="bg-[#1a1a1a] border-gray-800 shadow-lg overflow-hidden">
            ...
            <CardContent className="pt-6 space-y-4">
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400 flex items-center">
                    <Cpu className="mr-1 h-4 w-4 text-cyan-400" /> CPU Usage
                  </span>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400 flex items-center">
                    <MemoryStick className="mr-1 h-4 w-4 text-cyan-400" /> RAM Usage
                  </span>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400 flex items-center">
                    <Thermometer className="mr-1 h-4 w-4 text-cyan-400" />{" "}
                    Temperature
                  </span>
                ...
                <Progress
                  value={(systemStatus.temperature / 100) * 100}
                  className="h-2 bg-gray-700"
                />
              </div>
              ...
              <div className="flex justify-between text-sm pt-2 border-t border-gray-800">
                <span className="text-gray-400 flex items-center">
                  <Clock className="mr-1 h-4 w-4 text-cyan-400" /> Uptime
                </span>
          ...
          <Card className="bg-[#1a1a1a] border-gray-800 shadow-lg overflow-hidden">
            <CardHeader className="border-b border-gray-800 bg-[#1a1a1a]">
              ...
              <CardDescription className="text-gray-400">
                Activate or deactivate NORA modules
              </CardDescription>
            </CardHeader>
              ...
              <div className="space-y-4">
                {Object.entries(modules).map(([key, value]) => (
                  <div key={key} className="flex items-center justify-between">
                    <Label
                      htmlFor={`${key}-module`}
                      className="text-white capitalize flex-1"
                    >
                      {key}
                    </Label>
                    <div className="flex items-center space-x-2">
                      <span
                        className={`text-xs ${value ? "text-cyan-400" : "text-gray-500"}`}
                      >
                      ...
                      <Switch
                        ...
                        checked={value}
                        onCheckedChange={() =>
                          handleModuleToggle(key as keyof typeof modules)
                        }
          ...
          <Card className="bg-[#1a1a1a] border-gray-800 shadow-lg overflow-hidden md:col-span-2 lg:col-span-1">
            <CardHeader className="border-b border-gray-800 bg-[#1a1a1a]">
              ...
              <CardDescription className="text-gray-400">
                Recent user interactions with NORA
              </CardDescription>
            </CardHeader>
                ...
                <div className="divide-y divide-gray-800">
                  {userCommands.map((cmd) => (
                    <div key={cmd.id} className="p-4 hover:bg-gray-800/30">
                      ...
                      <p className="text-sm text-gray-300 mt-1 pl-6">
                        {cmd.command}
                      </p>
                    </div>
                  ))}
